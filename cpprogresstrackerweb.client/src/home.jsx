...
function Home() {
  ...
  async function getData(username) {
    ...
    try {
      ...
      const accountInfo = await fetch('GetAccountInformation', {
        method: 'POST',
        headers: {
      ...
      const res1 = await accountInfo.json();
      console.log(res1);
        ...
        {Object.keys(userData).map((topic) => (
          <div className='topicContainer'>
            ...
            <div className='tagsContainer'>
              ...
              <p className='solvedP'>{userData[topic].solved} Solved</p>
              <p className='notAccP'>
                {userData[topic].wa} not Accepted
              </p>
            </div>
            <Table hover striped responsive className='problemsTable'>
